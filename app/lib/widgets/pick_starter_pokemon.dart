...
List<Pokemon> _pokemonList = <Pokemon>[
  Pokemon("1", "Charmander", "CH", "type", "weakness", "description", 100, 100, "", "assets/pokemons/charmander.jpg", "assets/pokemons/charmander.jpg", "typeIcon", "weaknessIcon", false),
  Pokemon("2", "Bulbasaur", "BU", "type", "weakness", "description", 100, 100, "", "assets/pokemons/bulbasaur.jpg", "assets/pokemons/bulbasaur.jpg", "typeIcon", "weaknessIcon", false),
  Pokemon("3", "Squirtle", "SQ", "type", "weakness", "description", 100, 100, "", "assets/pokemons/squirtle.jpg", "assets/pokemons/squirtle.jpg", "typeIcon", "weaknessIcon", false),
];
                          ...
                          return GestureDetector(
                            child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: _selectedPokemon == pokemon.id ? Colors.blueAccent : Colors.grey,
                                    width: _selectedPokemon == pokemon.id ? 5.0 : 2.0,
                                  ),
