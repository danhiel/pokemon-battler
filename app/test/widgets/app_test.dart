...
void main() {
  group('App', () {
    testWidgets('renders correctly when starter pokemon doesn\'t exist', (WidgetTester tester) async {
    ...
    testWidgets('renders correctly when starter pokemon exist', (WidgetTester tester) async {
      await tester.pumpWidget(
          const MaterialApp(
              home: App()
          )
